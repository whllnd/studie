...
print("")
print("Average device carrying time [h]:          ", avg_device_time.mean(), avg_device_time.std(), avg_device_time.min(), avg_device_time.max())
print("Average device carrying time (cows) [h]:   ", avg_device_time_cows.mean(), avg_device_time_cows.std(), avg_device_time_cows.min(), avg_device_time_cows.max())
print("Average device carrying time (heifers) [h]:", avg_device_time_heif.mean(), avg_device_time_heif.std(), avg_device_time_heif.min(), avg_device_time_heif.max())
print("")
print("Average device carrying time when calving [h]:          ", avg_device_time_with_calving.mean(), avg_device_time_with_calving.std(), avg_device_time_with_calving.min(), avg_device_time_with_calving.max())
print("Average device carrying time when calving (cows) [h]:   ", avg_device_time_with_calving_cows.mean(), avg_device_time_with_calving_cows.std(), avg_device_time_with_calving_cows.min(), avg_device_time_with_calving_cows.max())
print("Average device carrying time when calving (heifers) [h]:", avg_device_time_with_calving_heif.mean(), avg_device_time_with_calving_heif.std(), avg_device_time_with_calving_heif.min(), avg_device_time_with_calving_heif.max())
print("")
