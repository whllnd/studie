library(readr)
library(data.table)
daten_moocall <- read_delim("Rohdaten/Rohdaten_10-Sep-2018_Kuehe.csv",
...
sink("2018-11-02_r_output_kuehe.txt")

for (Stunde in b) {
  for (Alarmtyp in a) {
    #file_name = paste0("3. Beratung/2018-10-01_python/confusion_table_", Stunde, "h", Alarmtyp, ".csv")
    file_name = paste0("./2018-10-01_python_kuehe/confusion_table_", Stunde, "h", Alarmtyp, ".csv")
    print(file_name)
